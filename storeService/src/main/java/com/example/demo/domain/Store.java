...
public class Store {
    ...
    public Store( String id, String ownerId, String name, String description,
    ...
    public static class StoreBuilder {
        ...
        public StoreBuilder ownerId( String ownerId ) {
            this.ownerId = ownerId;
            return this;
        }

        public Store build() {
            return new Store( id, ownerId, name, description, address, city, state );
        }
    }
}